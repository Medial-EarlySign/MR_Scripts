...
class Configuration:
    def __init__(self):
        ...
        self.filesFormatFunc = lambda f : re.match('.*Test_.*\.txt', f) is not None # files filter to upload from dataDir table
        ...
        self.dataAnalyzerFunLazy = lambda f, h:  csvAnalyzer.analyzeFileLazy(f, header = h, #pass header if files doesn't contain header
